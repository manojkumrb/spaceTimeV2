...
fem2=femInit();
fileName{1}=strcat(inpFiles,'\innerSelNodes - Copy.inp');%\inner_sampled_200.inp');%\halo.inp');%\hinge.inp');%
...
points=load('fullInnerCoord.mat'); % dense mesh
points=points.innerCoordi;              %
V=load('eigVecInner3_400.mat');%eigVec72nodes.mat');% % corresponding eigen vector
V=V.V;
